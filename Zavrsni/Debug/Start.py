...
board_size_select.grid(row=0,column=1)
...
number_of_pieces_label = Label(text="Select number of pieces:",font=roboto16).grid(row=1,column=0,padx=10,pady=15)
...
number_of_bishops_select.grid(row=4,column=5)
...
def startAllCombinations():
    ...
    rook_count = number_of_kings_option.get()
...
button_some_combinations = Button(window,text="Give me a couple of combinations!",height=2,bg="#dcf7d5", font=roboto12,command = startCoupleCombinations).grid(row=9,column=4)
button_all_combinations = Button(window, text="         Give me all combinations!       ",height=2,bg="#d5e4f7",font=roboto12, command=startAllCombinations).grid(row=10,column=4)
